...
(1) [one body isolated system](/data/simulation/1-Body),\
(2) [two-body conduction system](/data/simulation//2-Body),\
(3) [three-body natural convection system](/data/simulation//Convection), and\
(4) [an inverter module](/data/simulation/Inverter-Module) comprising six MOSFETs mounted on a printed circuit board assembly (PCBA) attached to a finned heatsink under natural convection and forced convection environment at constant flow velocity.

<p align="center">
<img src="/data/simulation/Inverter-Module/T_component.png" width="600">
</p>
...
Compressed versions of the Icepak files (.tzr), along with the raw input and output data in Excel format (.xlsx) are included for each use case. The training and test data in Excel format, for each code are included in [Code/Sequential-Parameter-Estimation](/code/sequential_parameter_estimation) and [Code/Ensemble-Parameter-Estimation](/code/ensemble_parameter_estimation) folders.
